...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='/path/to/experiments/dinomaly/mvtec/stage_3_data_selection/memory_score/noise_ratio_10/seed_0/z3/ensemble_100_p10/l2')
