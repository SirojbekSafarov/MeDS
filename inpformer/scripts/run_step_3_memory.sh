        ...
        for ratio in "${noise_ratios[@]}"; do
            for seed in "${seeds[@]}"; do
                for mad_factor in "${mad_factors[@]}"; do
                    ...
                    SAVE_DIR="/research/experiments/siroj/academic/noisy_ad/inpformer/mvtec/dino_v2_vit_base_backbone/multi_class/stage_3_pseudo_label_selection/memory_as_dataselector/noise_ratio_${ratio}/seed_${seed}/z${mad_factor}/ensemble_${ensemble}_p${scaled}/${loss_function}"
